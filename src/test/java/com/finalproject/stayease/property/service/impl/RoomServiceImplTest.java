...
public class RoomServiceImplTest {
  ...
  void testCreateRoom_ValidRequest() {
    ...
    Room createdRoom = roomService.createRoom(requestDTO);
  ...
  void testCreateRoom_DuplicateRoomName() {
    ...
    assertThrows(DuplicateEntryException.class, () -> roomService.createRoom(requestDTO));
  ...
  void testCreateRoom_PropertyNotFound() {
    ...
    assertThrows(InvalidRequestException.class, () -> roomService.createRoom(requestDTO));
    verify(propertyService, times(1)).findPropertyById(1L);
  }
  ...
  void testUpdateRoom_ValidRequest() {
    ...
    Room expectedRoom = roomService.updateRoom(roomId, requestDTO);
